...
<head>
    ...
    <!-- Title Start -->
    <title>Kuliner | Travelinary</title>
    <!-- End of Title -->
...
<body>
    ...
    <section id="category">
        ...
        <div class="container">
            ...
            <div class="categoryButton scrollHorizontal mt-3">
                <a href="destinasi.html" class="btn mr-2 px-4 btn-pill-disable">Semua</a>
                <a href="wisata.html" class="btn mr-2 px-4 btn-pill-disable">Wisata</a>
                <a href="kuliner.html" class="btn mx-2 px-4 btn-pill">Kuliner</a>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-3 col-md-4 my-2">
                    <a href="Destinasi/Kuliner/gudeg.html">
                        <div class="card">
                            <div class="love">
                                <img src="assets/img/wisata/gudeg1.jpeg" alt="gudeg">
                ...
                <div class="col-12 col-lg-3 col-md-4 my-2">
                    <a href="Destinasi/Kuliner/rendang.html">
                        <div class="card">
                            <div class="love">
                                <img src="assets/img/wisata/rendang.jpeg" alt="rendang">
                ...
                <div class="col-12 col-lg-3 col-md-4 my-2">
                    <a href="">
                        <div class="card">
                            <div class="love">
                                <img src="assets/img/wisata/pempek.jpeg" alt="pempek">
                               
                            </div>
                            <div class="desc px-3 py-2">
                                <h4 class="mb-1 nunitoBold">Pempek</h4>
                                <p class="mb-1"><i class="fa fa-map-marker"></i>Sumatera Selatan</p>
                                <p class="price mb-1">Rp 10,000 - 15.000</p>
                                <div class="d-flex align-self-center">
                                    <img src="assets/icon/Stars.svg" height="23" alt="">
                                    <p class="totalComments">(149)</p>
                ...
                <div class="col-12 col-lg-3 col-md-4 my-2">
                    <a href="">
                        <div class="card">
                            <div class="love">
                                <img src="assets/img/wisata/kerak.jpeg" alt="kerak telor">
                               
                            </div>
                            <div class="desc px-3 py-2">
                                <h4 class="mb-1 nunitoBold">Kerak Telor</h4>
