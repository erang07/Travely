        ...
        <div class="container event">
            ...
            <div class="row">
                <div class="col-12 col-md-4 my-2">
                    <a href="event/indonesia-art.php">
						<div class="card">
							...
							<div class="desc px-3 py-2">
								...
								<p class="price mb-1">Rp 150,000</p>
									</div>
                ...
                <div class="col-12 col-md-4 my-2">
                    <a href="event/aceh-culinary.php">
						<div class="card">
							<div class="love-event">
							<img src="assets/img/event/event3.jpg" alt="Festival Kuliner Aceh">
								<div class="iconLove">
									<p class="mb-2 ml-3"><i class="fas fa-user-friends"></i> 920</p>
								</div>	
							</div>
							<div class="desc px-3 py-2">
								<div class="row">
									<div class="col-9 ">
										<h4 class="mb-1 nunitoBold">Festival Kuliner</h4>
								<p class="mb-1"><i class="fa fa-map-marker"></i>Banda Aceh, Aceh</p>
								<p class="price mb-1">Rp 50,000</p>
									</div>
									<div class="col-3 align-self-center justify-content-center d-flex">
										<p class="nunitoBold textOrange  mb-0">Nov <span class="date">17</span></p>
									</div>
                ...
                <div class="col-12 col-md-4  my-2">
                    <a href="event/tour-de-singkarak.php">
						<div class="card">
							<div class="love-event">
							<img src="assets/img/event/event2.jpg" alt="Tour de Singkarak">
								<div class="iconLove">
									<p class="mb-2 ml-3"><i class="fas fa-user-friends"></i> 920</p>
								</div>	
							</div>
							...
							<div class="desc px-3 py-2">
								<div class="row">
									<div class="col-9 ">
										<h4 class="mb-1 nunitoBold">Tour de Singkarak</h4>
								<p class="mb-1"><i class="fa fa-map-marker"></i>Padang, Sumatera Barat</p>
								<p class="price mb-1">Rp 100,000</p>
									</div>
									<div class="col-3 align-self-center justify-content-center d-flex">
										<p class="nunitoBold textOrange  mb-0">Nov <span class="date">17</span></p>
									</div>
