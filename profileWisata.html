		...
		<div class="container">
			...
			<div class="row my-4">
				<ul class="nav nav-tabs col-12">
					<li class="nav-item">
					  <a class="nav-link active" href="profileWisata.html">Wisata <span class="total">2</span></a>
					</li>
					<li class="nav-item">
					  <a class="nav-link" href="profileKuliner.html">Kuliner <span class="total">3</span></a>
					</li>
					<li class="nav-item">
