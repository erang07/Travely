...
<head>
	...
	<!-- Title Start -->
	<title>Candi Tikus | Travelinary</title>
	<!-- End of Title -->
    ...
    <section id="detail-page">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					<center>
					<h2 class="font-weight-bold mb-3 header-mobile">Candi Tikus</h2>
					<div class="owl-carousel owl-theme detailPost mb-4">
						<div class="items">

							<img src="../../assets/img/wisata/candi-tikus.jpg" alt="">
						</div>
						<div class="items">
				...
				<div class="col-lg-3 sidebar nunitoRegular">
					<h2 class="font-weight-bold header-desktop">Candi Tikus</h2>
				...
				<div class="ulasan col-lg-12 row mt-5">
					<div class="float-start col-lg-6">
						<h3>Ulasan Pengunjung</h3>
					</div>
					<div class="col-lg-6 mb-4" style="text-align: right;">
						<button type="button" class="btn btn-pill nonAuth nunitoBold d-none px-4 pb-2" data-toggle="modal" data-target="#tambahUlasan">
							Tambah Ulasan
						  </button>
